...
const _DEFAULT_PROCESS_MATERIAL = preload("shaders/trail.gdshader")
const _DEFAULT_DRAW_PASS_1 = preload("shaders/trail_draw_pass.gdshader")
...
## Enable [member snap_to_transform] to snap the start of the trail to the nodes position.
## This may not be noticeable unless you
...
func _get_property_list():
	return [
		{"name": "_defaults_have_been_set", "type": TYPE_BOOL, "usage": PROPERTY_USAGE_NO_EDITOR}
	]
...
func set_defaults():
	...
	process_material.shader = _DEFAULT_PROCESS_MATERIAL

	draw_pass_1 = QuadMesh.new()
	draw_pass_1.material = ShaderMaterial.new()
	draw_pass_1.material.shader = _DEFAULT_DRAW_PASS_1
...
func _set_texture(value):
	...
	if value:
		...
		draw_pass_1.material.set_shader_parameter("tex", _DEFAULT_TEXTURE)
...
func _set_curve(value):
	...
	if value:
		...
		draw_pass_1.material.set_shader_parameter("curve", _DEFAULT_CURVE)
